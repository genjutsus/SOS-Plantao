document.addEventListener('DOMContentLoaded', () => {
    ...
    const resultTemplates = {
        form1: {
            text: '<strong> DINÂMICA DO FATO </strong> <br> <br> {input1}, através do funcionário {input2}, CPF {input3}, comunica o falecimento e solicitação a remoção de: {input4}, {input5}, natural do {input6}, {input7}, nascido em {input8}, identidade {input9}, com residência na {input10}. O falecido deu entrada no {input1} no dia {input11} às {input12} e foi gerado o número do BAM {input13}, prontuário {input14}. A morte, em tese, foi devido a {input15}, no local {input16}. O falecido deu entrada inicialmente no {input17}, através de {input18}. {input4} veio a óbito no dia {input19} às {input20}, atestado pelo médico {input21}, CRM {input22}. Guia {input23}. O cadáver foi identificado por {input24}, {input25} da vítima. <br> <br> <strong> TERMO DE DECLARAÇÃO </strong> <br> <br> QUE é funcionário de {input1}; QUE comunica o falecimento e solicitação a remoção de: {input4}, {input5}, natural do {input6}, {input7}, nascido em {input8}, identidade {input9}, com residência na {input10}; QUE o falecido deu entrada no {input1} no dia {input11} às {input12} e foi gerado o número do BAM {input13}, prontuário {input14}; QUE a morte, em tese, foi devido a {input15}, no local {input16}; QUE o falecido deu entrada inicialmente no {input17}, através de {input18}; QUE {input4} veio a óbito no dia {input19} às {input20}, atestado pelo médico {input21}, CRM {input22}; QUE o número da Guia é {input23}; QUE o cadáver foi identificado por {input24}, {input25} da vítima. E mais não disse.',
            instructions: '_____________ <br> Registro de Ocorrência, o crime é "Verificação para Remoção de Óbito". Após o R.O e o Termo, gere a peça Guia de Remoção de Cadáver e, por fim, ligue para o número (21) 8596-9532 para acionar a remoção.'
        },
        form2: {
            text: 'Email: {input26}\nTelefone: {input27}',
